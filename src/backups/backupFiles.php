<?php
	...
	*/
	...
	$command = "tar -pcvzf /var/www/html" . $DOCUMENT_ROOT . "/backups/files/FILES_" . date("Y-m-d-H-i-s") . ".tar.gz --exclude=*.tar.gz --exclude=/var/www/backups /var/www/html" . $DOCUMENT_ROOT . "";
