...
function showInverter(str) {
    ...
    xmlhttp.open("GET","../charts/table_inverter_history.php?inv="+str,true);
    xmlhttp.send();
  }
}
</script>
		...
		<div class="">
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<h2><?php echo $LANG_PAGES_T_INVERTER_TITLE;?></h2>
						...
						<div class="x_content">
							<div class="pull-right">
								...
								<select id="inverter" onchange="showInverter(this.value)">
									<option value=""><?php echo $LANG_PAGES_T_INVERTER_SELECT;?></option>
									<?php
							...
							<br><br />
							<div id="inverter_result"><b><?php echo $LANG_PAGES_T_INVERTER_RESULT;?></b></div>
						</div>
					</div>
				</div>
			</div>
